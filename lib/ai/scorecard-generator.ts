...
function buildScorecardPrompt(
  ...
  const systemPrompt = [
    ...
    '  "suggested_scenarios": [',
    '    {',
    '      "title": "string — a SPECIFIC, actionable practice task (NOT a generic skill name)",',
    '      "why": "string — 1 sentence explaining why, citing the user\'s actual behavior from the session",',
    '      "practice_goal": "string — what success looks like (e.g. \'Ask at least 2 genuine follow-up questions\')",',
    ...
    availableScenarios?.length
      ...
      : "",
    "If no good match exists, invent a focused skill title and set matched_scenario_id to null.",
    "",
    "CRITICAL RULES FOR TITLES:",
    "- Do NOT use generic skill names like 'Building Rapport' or 'Active Listening Practice'.",
    "- Titles MUST describe a SPECIFIC practice task, e.g.:",
    "  GOOD: 'Asking follow-up questions when someone mentions hobbies'",
    "  GOOD: 'Sharing a personal story when your date opens up about theirs'",
    "  GOOD: 'Noticing and responding to hesitation cues'",
    "  BAD: 'Engaging in small talk'",
    "  BAD: 'Building rapport'",
    "  BAD: 'Active listening'",
    "",
    "CRITICAL RULES FOR WHY:",
    "- The 'why' field MUST reference specific behavior from THIS session.",
    "- Cite what the user actually did or failed to do, e.g.:",
    "  GOOD: 'You missed 3 chances to ask follow-ups when Jordan mentioned hiking and cooking'",
    "  GOOD: 'Your responses averaged 6 words — try sharing more about yourself'",
    "  BAD: 'This will help you improve'",
    "  BAD: 'You need to work on this skill'",
    "",
    "Each suggestion MUST include skill_focus, why, and practice_goal.",
    scenarioList,
  ]
    .filter(Boolean)
    .join("\n");
